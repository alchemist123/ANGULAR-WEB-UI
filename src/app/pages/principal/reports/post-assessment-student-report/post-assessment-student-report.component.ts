...
@Component({
  selector: 'app-post-assessment-student-report',
  templateUrl: './post-assessment-student-report.component.html',
  styleUrls: ['./post-assessment-student-report.component.css']
})
export class PostAssessmentStudentReportComponent implements OnInit {
  lessonId: any;
  type: any;
  questions:any;
  answers:any;
  ...
  getStudentReports(){
    this.communicationsService.executePOSTAPI(APIStandars.principal.getStudentReports,{lessonId:this.lessonId, lessonType:"20", standardId:this.standardId, divisionId:this.divisionId}).subscribe(
      (data)=>{
       this.overview=data
